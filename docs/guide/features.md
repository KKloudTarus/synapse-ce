...
Ubuntu, Debian, Oracle Linux, AlmaLinux, and openSUSE OVAL feeds plus Amazon Linux updateinfo so that detection does not depend on one provider. A freshness check warns
