> Canonical source: [`docs/architecture/promotion-rules.md`](https://github.com/KKloudTarus/synapse-ce/blob/main/docs/architecture/promotion-rules.md). Do not edit this published mirror directly.
