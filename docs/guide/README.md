...
| [Vulnerability intelligence](vulnerability-intelligence.md) | Sources, synchronization, reconciliation, rollout, recovery, and security controls |
| [Cloud posture](cloud-posture.md) | Read-only AWS, Azure, and Google Cloud inventory, checks, and least privilege |
