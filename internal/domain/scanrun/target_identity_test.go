...
func TestCanonicalizeRepositoryTarget(t *testing.T) {
	tests := []struct {
		...
		{
			name:          "ssh url with git user matches scp spelling",
			rawURL:        "ssh://git@example.com/org/repo.git",
			rawRevision:   "e54b4a04e54b4a04e54b4a04e54b4a04e54b4a04",
			wantCanonical: "ssh://example.com/org/repo",
			wantRevision:  "e54b4a04e54b4a04e54b4a04e54b4a04e54b4a04",
			wantErr:       false,
		},
		{
			name:          "encoded slash does not collapse repository identity",
			rawURL:        "https://github.com/org/repo%2F..%2Fother",
			rawRevision:   "e54b4a04e54b4a04e54b4a04e54b4a04e54b4a04",
			wantCanonical: "https://github.com/org/repo%2F..%2Fother",
			wantRevision:  "e54b4a04e54b4a04e54b4a04e54b4a04e54b4a04",
			wantErr:       false,
		},
		{
			name:          "ipv6 repository host stays bracketed",
			rawURL:        "ssh://git@[2001:db8::1]:22/org/repo.git",
			rawRevision:   "e54b4a04e54b4a04e54b4a04e54b4a04e54b4a04",
			wantCanonical: "ssh://[2001:db8::1]/org/repo",
			wantRevision:  "e54b4a04e54b4a04e54b4a04e54b4a04e54b4a04",
			wantErr:       false,
		},
		{
...
func TestCanonicalizeCloudResourceTarget(t *testing.T) {
	...
	left, err := scanrun.CanonicalizeCloudResourceTarget("aws", "123/456", "x")
	if err != nil {
		t.Fatal(err)
	}
	right, err := scanrun.CanonicalizeCloudResourceTarget("aws", "123", "456/x")
	if err != nil {
		t.Fatal(err)
	}
	if left.TargetIdentityCanonical == right.TargetIdentityCanonical {
		t.Fatalf("cloud resource tuples collided: %q", left.TargetIdentityCanonical)
	}
}
