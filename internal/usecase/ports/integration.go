...
type IntegrationStore interface {
	...
	ResolveIntegrationCredential(ctx context.Context, integrationID shared.ID, credentialID string) ([]byte, error)
	...
	StartIntegrationOperation(ctx context.Context, operation integration.Operation, jobKind string, payload []byte) (integration.Operation, error)
	...
	UpsertIntegrationExternalRuns(ctx context.Context, runs []integration.ExternalRun) error
