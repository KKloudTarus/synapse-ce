...
var explicitInventory = []string{
	...
	"kubernetes-allow-priv-escalation", "kubernetes-automount-sa-token", "kubernetes-caps-not-dropped", "kubernetes-configmap-credential", "kubernetes-dangerous-capability", "kubernetes-default-namespace", "kubernetes-default-service-account", "kubernetes-host-ipc", "kubernetes-host-network", "kubernetes-host-path", "kubernetes-host-pid", "kubernetes-host-port", "kubernetes-image-no-tag", "kubernetes-ingress-no-tls", "kubernetes-ingress-tls-no-secret", "kubernetes-image-no-digest", "kubernetes-image-pull-policy-cached", "kubernetes-namespace-no-network-policy", "kubernetes-no-cpu-limit", "kubernetes-no-cpu-request", "kubernetes-no-memory-limit", "kubernetes-no-memory-request", "kubernetes-no-priv-escalation-disabled", "kubernetes-no-read-only-root-fs", "kubernetes-no-run-as-group", "kubernetes-no-run-as-non-root", "kubernetes-no-run-as-user", "kubernetes-no-seccomp", "kubernetes-privileged", "kubernetes-rbac-cluster-admin-binding", "kubernetes-rbac-escalation-verbs", "kubernetes-rbac-wildcard-permissions", "kubernetes-run-as-root", "kubernetes-secret-env-var", "kubernetes-secret-in-env", "kubernetes-secret-in-manifest",
