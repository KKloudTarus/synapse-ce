...
func rustRules() []rule.Rule {
	unsafe_ := []rustRuleSpec{
		...
		rustRule("unaligned-raw-ptr-read", "Unaligned raw pointer read", "CWE-125", "let val = unsafe { std::ptr::read_unaligned(ptr) };", "let val = unsafe { *(ptr as *const u64) };", "Use std::ptr::read_unaligned when pointer memory alignment cannot be guaranteed.", rule.TypeBug, rule.QualityReliability, shared.SeverityMedium),
	...
	ffi := []rustRuleSpec{
		rustRule("ffi-null-ptr-unchecked", "Raw pointer from FFI used without null check", "CWE-476", "extern \"C\" fn handle(ptr: *const u8) {\n    if !ptr.is_null() {\n        let _val = unsafe { *ptr };\n    }\n}", "extern \"C\" fn handle(ptr: *const u8) {\n    let _val = unsafe { *ptr };\n}", "Verify pointers returned from external FFI calls before dereferencing.", rule.TypeBug, rule.QualityReliability, shared.SeverityHigh),
	...
	maint := []rustRuleSpec{
		rustRule("long-function-statements", "Function exceeds statement count threshold", "CWE-1120", "fn process() {\n    step_one();\n    step_two();\n}", "fn process() {\n    let a = 1;\n    let b = 2;\n    let c = 3;\n    let d = 4;\n    let e = 5;\n    let f = 6;\n    let g = 7;\n    let h = 8;\n    let i = 9;\n    let j = 10;\n    let k = 11;\n    let l = 12;\n    let m = 13;\n    let n = 14;\n    let o = 15;\n    let p = 16;\n    let q = 17;\n    let r = 18;\n    let s = 19;\n    let t = 20;\n    let u = 21;\n    let v = 22;\n    let w = 23;\n    let x = 24;\n    let y = 25;\n    let z = 26;\n    let a2 = a + 1;\n    let b2 = b + 1;\n    let c2 = c + 1;\n    let d2 = d + 1;\n    let e2 = e + 1;\n    let f2 = f + 1;\n    let g2 = g + 1;\n    let h2 = h + 1;\n    let i2 = i + 1;\n    let j2 = j + 1;\n    let k2 = k + 1;\n    let l2 = l + 1;\n    let m2 = m + 1;\n    let n2 = n + 1;\n    let o2 = o + 1;\n    let p2 = p + 1;\n    let q2 = q + 1;\n    let r2 = r + 1;\n    let s2 = s + 1;\n    let t2 = t + 1;\n    let u2 = u + 1;\n    let v2 = v + 1;\n    let w2 = w + 1;\n    let x2 = x + 1;\n    let y2 = y + 1;\n    let z2 = z + 1;\n}", "Break large functions into smaller helper functions.", rule.TypeCodeSmell, rule.QualityMaintainability, shared.SeverityLow),
