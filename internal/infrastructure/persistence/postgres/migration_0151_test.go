...
func TestMigration0151EvidenceImmutabilityTenantBindingAndRollback(t *testing.T) {
	...
	if err := goose.DownTo(db, ".", 150); err == nil || !strings.Contains(err.Error(), "evidence exists") {
