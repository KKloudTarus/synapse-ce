...
func TestMigration0149DefinesImmutableTenantSafeClosureReports(t *testing.T) {
	data, err := migrations.FS.ReadFile("0149_assessment_closure_reports.sql")
	if err != nil {
		t.Fatal(err)
	}
	sql := string(data)
...
func TestMigration0149UpgradePaths(t *testing.T) {
	for _, from := range []int64{137, 138, 148} {
